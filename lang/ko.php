...
// OAuth settings
$lang->mcpserver_section_oauth = 'OAuth 2.0 인증';
$lang->mcpserver_oauth_description = 'OAuth 2.0 인증을 활성화하면 MCP 클라이언트가 Bearer 토큰을 사용하여 인증해야 합니다. MCP 사양의 OAuth 2.0 Authorization Code + PKCE 플로우를 지원합니다.';
$lang->mcpserver_oauth_enable = 'OAuth 2.0 활성화';
$lang->mcpserver_oauth_enable_help = 'OAuth 2.0 인증을 활성화합니다. 활성화 시 인증되지 않은 요청은 거부됩니다. (기본값: 비활성화)';
$lang->mcpserver_oauth_password = '인증 비밀번호';
$lang->mcpserver_oauth_password_placeholder = '비밀번호를 변경하려면 입력하세요';
$lang->mcpserver_oauth_password_help = 'OAuth 인증 페이지에서 사용할 비밀번호입니다. MCP 클라이언트가 인증을 요청할 때 이 비밀번호를 입력해야 합니다.';
$lang->mcpserver_oauth_password_required = 'OAuth 2.0이 활성화되었지만 인증 비밀번호가 설정되지 않았습니다. 비밀번호를 설정해주세요.';

// OAuth client list
$lang->mcpserver_oauth_clients_title = '등록된 OAuth 클라이언트';
$lang->mcpserver_oauth_no_clients = '등록된 OAuth 클라이언트가 없습니다.';
$lang->mcpserver_oauth_client_id = 'Client ID';
$lang->mcpserver_oauth_client_name = '클라이언트 이름';
$lang->mcpserver_oauth_client_grant_types = 'Grant Types';
$lang->mcpserver_oauth_client_auth_method = '인증 방식';
$lang->mcpserver_oauth_client_created_at = '등록일';
$lang->mcpserver_oauth_client_actions = '관리';
$lang->mcpserver_oauth_regenerate_secret = '시크릿 재생성';
$lang->mcpserver_oauth_regenerate_secret_confirm = '클라이언트 시크릿을 재생성하시겠습니까? 기존 시크릿은 더 이상 사용할 수 없습니다.';
$lang->mcpserver_oauth_delete_client = '클라이언트 삭제';
$lang->mcpserver_oauth_delete_client_confirm = '이 OAuth 클라이언트를 삭제하시겠습니까? 이 작업은 되돌릴 수 없습니다.';
$lang->mcpserver_oauth_new_secret = '새 Client Secret';
$lang->mcpserver_oauth_new_secret_warning = '이 시크릿은 다시 표시되지 않습니다. 안전한 곳에 저장해주세요.';
$lang->mcpserver_oauth_has_secret = '있음';
$lang->mcpserver_oauth_no_secret = '없음';

// OAuth public URL
$lang->mcpserver_oauth_public_url = 'OAuth 공개 URL';
$lang->mcpserver_oauth_public_url_placeholder = 'https://example.com';
$lang->mcpserver_oauth_public_url_help = 'OAuth 메타데이터에 표시될 공개 URL입니다. 설정하지 않으면 내부 서버 주소(http://127.0.0.1:포트)가 사용됩니다. 리버스 프록시를 통해 외부에 노출하는 경우 반드시 설정하세요. (예: https://fanbinit.us)';

// OAuth manual client registration
$lang->mcpserver_oauth_register_title = '수동 클라이언트 등록';
$lang->mcpserver_oauth_register_btn = '클라이언트 등록';
$lang->mcpserver_oauth_register_name_placeholder = '클라이언트 이름을 입력하세요';
$lang->mcpserver_oauth_register_name_required = '클라이언트 이름을 입력해주세요.';
...
$lang->mcpserver_oauth_register_redirect_uris_help = '한 줄에 하나씩 Redirect URI를 입력하세요. authorization_code 방식에서는 필수입니다.';
